      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 sm:mb-16 gap-6 px-4 md:px-0">
          <div className="text-center md:text-left">
            ...
            <p className="font-light text-lg sm:text-xl lg:text-2xl text-drica-dark/70 text-pretty break-words">
          ...
          >
            {depoimentos.map((depoimento, index) => (
              ...
              >
                ...
                <p className="text-drica-dark/80 font-light text-base leading-relaxed flex-grow relative z-10 break-words">
                  "{depoimento.texto}"
                </p>
