      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
          {pilares.map((pilar) => (
            <div 
              key={pilar.title} 
              className={`group p-8 sm:p-10 lg:p-12 bg-drica-light rounded-[2.5rem] border-b-[8px] sm:border-b-[12px] ${pilar.colorTheme.border} transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl relative overflow-hidden flex flex-col items-center sm:text-center`}
            >
